...
# from math import Base64 # esto da error porque la función es base64 (todo en minúsculas)

# ValueError

# print(int("10 Años")) # da error porque no se puede convertir a entero una cadena de caracteres.
